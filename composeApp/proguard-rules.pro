...
-keepclasseswithmembers public class org.charr0max.buscaminas.MainKt {  # <-- Change com.company to yours
...
-keep,includedescriptorclasses class org.charr0max.buscaminas.**$$serializer { *; }  # <-- Change com.kotlearn.minesweeperk
-keepclassmembers class com.charr0max.buscaminas.** {  # <-- Change com.kotlearn.minesweeperk to yours
    *** Companion;
}
-keepclasseswithmembers class org.charr0max.buscaminas.** { # <-- Change com.kotlearn.minesweeperk to yours
    kotlinx.serialization.KSerializer serializer(...);
}
